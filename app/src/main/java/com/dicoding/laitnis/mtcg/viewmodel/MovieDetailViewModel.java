...
public class MovieDetailViewModel extends ViewModel {
    ...
    public void setVideo(final String movId) {

        AsyncHttpClient client = new AsyncHttpClient();
        final ArrayList<Video> listItems = new ArrayList<>();
        String url = "https://api.themoviedb.org/3/movie/" + movId + "/videos?api_key=" + API_KEY + "&language=en-US";
    ...
    public void setGenre(final String movId) {
        ...
        String url = "https://api.themoviedb.org/3/movie/" + movId + "?api_key=" + API_KEY + "&language=en-US";
        client.get(url, new AsyncHttpResponseHandler() {
    ...
    public void setCast(final String movId) {
        ...
        String url = "https://api.themoviedb.org/3/movie/" + movId + "/credits?api_key=" + API_KEY;
        client.get(url, new AsyncHttpResponseHandler() {
