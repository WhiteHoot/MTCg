...
public class TVShowHighRated implements Parcelable {

    public static final Parcelable.Creator<TVShowHighRated> CREATOR = new Parcelable.Creator<TVShowHighRated>() {
        @Override
        public TVShowHighRated createFromParcel(Parcel source) {
            return new TVShowHighRated(source);
        }

        @Override
        public TVShowHighRated[] newArray(int size) {
            return new TVShowHighRated[size];
        }
    };
    ...
    public TVShowHighRated(JSONObject object) {
        try {
    ...
    public TVShowHighRated() {

    }

    protected TVShowHighRated(Parcel in) {
