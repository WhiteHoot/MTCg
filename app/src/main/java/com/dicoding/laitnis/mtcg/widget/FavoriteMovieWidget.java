...
public class FavoriteMovieWidget extends AppWidgetProvider {
    ...
    public static final String EXTRA_ITEM = "com.dicoding.laitnis.mtcg.EXTRA_ITEM";
    private static final String TOAST_ACTION = "com.dicoding.laitnis.mtcg.TOAST_ACTION";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            Log.e("WidgetUpdate", "Widget has been updated");
        }
    }
